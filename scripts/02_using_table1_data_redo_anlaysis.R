...
d = fread('sr15datadump/20170724_Table1_orig_out.txt')
...
### Y: Yes, N: No
d[, gene.format:=gsub('Sr15.*','Y',Gene, ignore.case = T)][,gene.format:=gsub('Sr.*','-',gene.format)][,gene.format:=gsub('-','N',gene.format)][,gene.format:=gsub('unknown','N',gene.format)]
...
d[, gene.format2:=gsub('Sr15.*','Y',Gene, ignore.case = T)][,gene.format2:=gsub('Sr.*',NA,gene.format2)][,gene.format2:=gsub('-','N',gene.format2)][,gene.format2:=gsub('unknown','N',gene.format2)]
